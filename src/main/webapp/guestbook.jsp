...
%>
    ...
    List<Entity> greetings = null;
	try {
	    Query query = new Query("Greeting", guestbookKey).addSort("date", Query.SortDirection.DESCENDING);
	    greetings = datastore.prepare(query).asList(FetchOptions.Builder.withLimit(25));
	...
	<section id="Messages">
		...
		<div class="message">
			...
			<%
                ...
                String firstLetter = ((String) (((User) greeting.getProperty("user")).getNickname())).substring(0,1);
		...
		<div class="message">
            ...
            long elapsed = System.currentTimeMillis() - ((Date) (greeting.getProperty("date"))).getTime();
            int index = -1;
	        ...
	        if (index == -1)
	        	...
	        	pageContext.setAttribute("greeting_date", dateFormat[index].format(((Date) (greeting.getProperty("date"))).getTime()));//+" "+debugg+" "+debug2);
	        } else {
	        	TimeZone.setDefault(TimeZone.getTimeZone("GMT"));
        		pageContext.setAttribute("greeting_date", dateFormat[index].format(new Date(elapsed)));
	        }
            
		%>	<p class="content"><%pageContext.setAttribute("greeting_content", greeting.getProperty("content"));
...
%>
	<section>
            <form name="greeting" action="/sign" method="post">
